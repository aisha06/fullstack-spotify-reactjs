...
const Addsong = () => {
  ...
  return   loading?(<div className='grid place-items-center min-h-[80vh]'>
   ...
   <form onSubmit={onSubmitHandler}    className='flex flex-col items-start gap-8 text-gray-800'>
    <div className='flex gap-8'>
        ...
        <div className='flex flex-col gap-4'>
            ...
            <label htmlFor='image'>
           <img src={image?URL.createObjectURL(image):assets.upload_song} className='w-24 cursor-pointer' alt=''/>
            </label>       
        </div>
    </div>
   ...
   <select onChange={(e)=>setDesc(e.target.value)}   className='bg-transparent outline-green-600 border-2 border-gray-400 p-2.5 w-[150px]'>
